...
urlpatterns = [
    ...
    path('detailedsuperadminreports',views.detailed_superadmin_reports,name='detailed_superadmin_reports'),
    ...
    path('escalationmatrix/', views.escalationmatrix, name='escalationmatrix'),
    path('editescalationmatrix/<int:escalation_id>/', views.edit_escalationmatrix, name='edit_escalationmatrix'),
    path('deleteescaltionmatrix/<int:escalation_id>/', views.delete_escalationmatrix, name='delete_escalationmatrix'),
    path('sendemail/',views.send_email, name='sendemail'),
    path('editmail/<int:id>/',views.edit_email, name='editmail'),
    path('delemail/<int:id>/',views.delete_email, name='delemail'),
    path('messageshoot/',views.messageshoot,name = 'messageshoot'),
    path('complaintsearch/',views.complaint_search,name = 'complaintsearch'),
    path('usercomplaintsearch/',views.user_complaint_search,name = 'usercomplaintsearch'),
    path('resolvercomplaintsearch/',views.resolver_complaint_search,name = 'resolvercomplaintsearch'),
    path('signaturemaster/',views.signature_master,name ='signaturemaster'),
